...
const appInitialize = (config, doc, zone) => {
    return () => {
        ...
        if (win && typeof window !== 'undefined') {
            initialize(Object.assign({}, config, { _zoneGate: (h) => zone.run(h) }));
